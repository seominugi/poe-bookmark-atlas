...
document.getElementById('app').innerHTML = `
  <div class="pop">
    ...
    <div class="pop-cta">
      ...
      <button class="pop-btn pop-btn--ghost" id="pop-cross">${icon('external', 14)}<span id="pop-cross-tx">영문 거래소 전환 켜기</span></button>
...
// 영문 거래소 전환 — pathofexile.com optional 권한 토글 (권한 요청은 확장 페이지에서만 가능)
...
async function refreshCross() {
  ...
  $('pop-cross-tx').textContent = granted ? '영문 거래소 전환: 켜짐 ✓' : '영문 거래소 전환 켜기'
}
