...
> ⚠️ **이 문서는 v0.1.0 오픈 베타 기준이다.** 스토어 등록 정보·권한 사유·개인정보 공시의
> **정본은 루트 [`CHROMEWEBSTORE.md`](../CHROMEWEBSTORE.md)** 로 옮겼다(2026-08-19, 현재 0.9.1).
> 여기 남은 내용은 패키징 절차와 초기 등록 경위 기록으로만 참고한다.
