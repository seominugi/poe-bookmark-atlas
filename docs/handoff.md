...
**0.6.5 릴리즈 게시 완료(재게시) · 스토어 제출 대기 (2026-08-06)** — `develop` → `main` fast-forward(`6836a23..266392a`, 11커밋) → **`v0.6.5` 태그 publish(現 `Latest`, 대상 `266392a`)**. `deploy/poe-bookmark-atlas-0.6.5.zip`(31파일·801KB, manifest 루트 확인) 생성. **남은 것: 사용자가 스토어 심사 제출.**
