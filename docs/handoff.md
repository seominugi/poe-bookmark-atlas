...
⚠ **선행 확인 1건**: 0.3.0을 스토어에 실제로 제출·게시했는지 (GitHub v0.3.0은 19일째 draft, 태그 미생성). 안 올렸다면 0.3.0 내용도 0.4.0 릴리즈 노트에 함께 담아야 한다(초안은 그렇게 작성됨) — 올렸다면 그 절을 지우고 v0.3.0 draft는 따로 publish.
